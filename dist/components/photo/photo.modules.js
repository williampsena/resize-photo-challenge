...
PhotoModule = __decorate([
    common_1.Module({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'Photo', schema: photo_schema_1.PhotoSchema }])],
        controllers: [photo_controller_1.PhotoController],
        components: [photo_service_1.PhotoService],
    })
], PhotoModule);
exports.PhotoModule = PhotoModule;
//# sourceMappingURL=photo.modules.js.map